...
class SingleEpisodeCharactersAdapter :
    ListAdapter<MultipleCharactersDtoItem, SingleEpisodeCharactersAdapter.SingleCharacterEpisodesViewHolder>(
        EpisodeCharsDiffCallback()
    ) { 
    ...
    private class EpisodeCharsDiffCallback : DiffUtil.ItemCallback<MultipleCharactersDtoItem>() {
